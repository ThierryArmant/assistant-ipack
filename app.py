...
# 1. INITIALISATION DE LA MÉMOIRE (Évite le gel du chat)
...
st.markdown(f"""
    ...
    .scroll-chat {{
        height: 340px !important; overflow-y: auto !important; padding: 15px;
...
# 3. CONFIGURATION CONFIGURATION IA
...
# 4. CHARGEMENT INDEX (LOCAL DATA UNIQUEMENT POUR LA SÉCURITÉ ACCÉLÉRÉE)
@st.cache_resource
...
# 5. INTERFACE ET AFFICHAGE DES DEUX COLONNES
...
with col1:
    ...
    with st.container(border=True):
        ...
        prompt_ipack = st.chat_input("Votre question iPack...", key="input_ipack")
...
# 6. ENVOI ET TRAITEMENT DES MESSAGES (RÉACTIF ET SÉCURISÉ)
if prompt_ipack and index_ia:
